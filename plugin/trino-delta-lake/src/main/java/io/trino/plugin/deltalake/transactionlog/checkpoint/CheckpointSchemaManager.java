...
public class CheckpointSchemaManager
{
    ...
    public RowType getAddEntryType(MetadataEntry metadataEntry, boolean requireWriteStatsAsJsonStatsAsJson, boolean requireWriteStatsAsStruct)
    {
        ...
        if (requireWriteStatsAsJsonStatsAsJson) {
